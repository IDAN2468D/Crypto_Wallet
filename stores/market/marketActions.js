...
export const GET_COIN_MARKET_BEGIN = "GET_MARKET_BEGIN"
export const GET_COIN_MARKET_SUCCESS = "GET_MARKET_SUCCESS"
export const GET_COIN_MARKET_FAILURE = "GET_MARKET_FAILURE"
...
export const getHoldingsFailure = (erorr) => ({
...
export function getHoldings(
    ...
    return dispatch => {
        ...
        return axios({
            ...
            if (response.state == 200) {
                let myHoldings = response.data.map((item) => {
                    ...
                    return {
                        ...
                        price_change_percentage_7d_in_currency: item,
            ...
            dispatch(getHoldingsFailure(erorr))
        })
    }
}
